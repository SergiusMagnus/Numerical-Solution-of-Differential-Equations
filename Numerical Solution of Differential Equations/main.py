...
if __name__ == '__main__':
    ...
    # solve_SE(start=0., end=1.5, step=0.01, method="ROSM")

    # solve_SDE_1(start=0., end=0.3, step=0.001, method="EM")
    # solve_SDE_1(start=0., end=0.3, step=0.001, method="RKM")
    ...
    # solve_SDE_2(start=0., end=0.001, step=0.00001, method="RKM")
    ...
    # solve_SDE_2(start=0., end=0.001, step=0.00001, method="ROSM")
